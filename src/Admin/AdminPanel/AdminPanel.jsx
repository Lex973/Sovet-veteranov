...
const AdminPanel = () => {
    ...
    const handleCreateHashtag = (e) => {
        e.preventDefault();
        console.log('Создание хештега');
    };

    const handleCreateCommittee = (e) => {
        e.preventDefault();
        console.log('Создание члена комитета');
    };

    const handleCreateTeam = (e) => {
        e.preventDefault();
        console.log('Создание члена команды');
    };
    ...
    return (
        <div>
            ...
            {/* Форма 1 - Создание поста */}
            <form onSubmit={handleCreatePost} className="mt-15 w-1/2 mx-auto flex flex-col gap-8">
                ...
                <Button type="submit" width="w-full" height="h-15">Создать пост</Button>

                <Line/>
            </form>

            {/* Форма 2 - Создание хештега */}
            <form onSubmit={handleCreateHashtag} className="w-1/2 mx-auto flex flex-col gap-8">
            ...
            {/* Форма 3 - Создание члена комитета */}
            <form onSubmit={handleCreateCommittee} className="w-1/2 mx-auto flex flex-col gap-8">
                ...
                <Button type="submit" width="w-full" height="h-15">Создать члена комитета</Button>

                <Line/>
            </form>

            {/* Форма 4 - Создание члена команды */}
            <form onSubmit={handleCreateTeam} className="w-1/2 mx-auto flex flex-col gap-8">
                    ...
                    <div className="flex items-center justify-between gap-6 p-4 border-2 border-gray-300 rounded-lg">
                        ...
                        <div className="flex gap-4 justify-center items-center">
                            <Button
                                ...
                                height="h-auto"
                                noMargin={true}
                                isActive={newYearDecor}
                                onClick={() => setNewYearDecor(!newYearDecor)}
                            >
                            ...
                            <Button
                                ...
                                height="h-auto"
                                noMargin={true}
                                isActive={newYearEffects}
                                onClick={() => setNewYearEffects(!newYearEffects)}
                            >
                    ...
                    <div className="flex items-center justify-between gap-6 p-4 border-2 border-gray-300 rounded-lg">
                        ...
                        <div className="flex gap-4">
                            <Button
                                ...
                                height="h-auto"
                                noMargin={true}
                                isActive={victoryDayDecor}
                                onClick={() => setVictoryDayDecor(!victoryDayDecor)}
                            >
                            ...
                            <Button
                                ...
                                height="h-auto"
                                noMargin={true}
                                isActive={victoryDayEffects}
                                onClick={() => setVictoryDayEffects(!victoryDayEffects)}
                            >
